...
const products = [
    // ইলেকট্রনিক্স
    {
        ...
        rating: 4.5,
        reviews: 250,
        seller: "টেক স্টোর বাংলাদেশ",
        hotDeal: true,
        description: "সর্বশেষ প্রযুক্তির স্মার্ট ওয়াচ যা আপনার স্বাস্থ্য ট্র্যাক করতে পারে।"
    },
    {
        id: 2,
        ...
        seller: "অডিও প্লাস",
        hotDeal: true,
        description: "উচ্চমানের সাউন্ড কোয়ালিটি সহ ওয়্যারলেস ইয়ারবাড।"
    },
    {
        id: 3,
        ...
        seller: "চার্জিং হাব",
        hotDeal: false,
        description: "দ্রুত চার্জিং প্রযুক্তি সহ পাওয়ারফুল পাওয়ার ব্যাংক।"
    },
    {
        id: 4,
        title: "ওয়েব ক্যামেরা HD",
        category: "ইলেকট্রনিক্স",
        originalPrice: 2999,
        currentPrice: 1299,
        emoji: "📷",
        ...
        seller: "ভিডিও সলিউশন",
        hotDeal: true,
        description: "ক্রিস্টাল ক্লিয়ার HD ভিডিও কোয়ালিটি সহ ওয়েব ক্যামেরা।"
    },
    ...
    // ফ্যাশন
    {
        ...
        seller: "ফ্যাশন হাব",
        hotDeal: false,
        description: "আরামদায়ক এবং টেকসই কটন টি-শার্ট।"
    },
    {
        id: 6,
        title: "জিনস প্যান্ট",
        ...
        seller: "ডেনিম স্টোর",
        hotDeal: true,
        description: "স্টাইলিশ এবং আরামদায়ক জিনস প্যান্ট।"
    },
    {
        id: 7,
        title: "স্নিকার শুজ",
        ...
        seller: "শুজ পার্টনার",
        hotDeal: false,
        description: "আধুনিক ডিজাইনের আরামদায়ক স্নিকার শুজ।"
    },
    {
        id: 8,
        title: "স্প্রিং জ্যাকেট",
        category: "ফ্যাশন",
        originalPrice: 3500,
        currentPrice: 1499,
        emoji: "🧥",
        rating: 4.3,
        reviews: 120,
        seller: "আউটার ওয়্যার",
        hotDeal: true,
        description: "হালকা এবং স্টাইলিশ স্প্রিং জ্যাকেট।"
    },

    // বই
    {
        id: 9,
        title: "বাংলা সাহিত্য সংগ্রহ",
        category: "বই",
        originalPrice: 1500,
        currentPrice: 699,
        emoji: "📚",
        ...
        seller: "বই পাঠাগার",
        hotDeal: false,
        description: "বাংলা সাহিত্যের সেরা রচনাগুলির সংগ্রহ।"
    },
    {
        id: 10,
        title: "প্রোগ্রামিং গাইড",
        category: "বই",
        originalPrice: 2000,
        currentPrice: 899,
        emoji: "💻",
        ...
        seller: "টেক বুকস",
        hotDeal: true,
        description: "জাভাস্ক্রিপ্ট এবং ওয়েব ডেভেলপমেন্টের সম্পূর্ণ গাইড।"
    },
    {
        id: 11,
        title: "ইতিহাস পাঠ",
        ...
        rating: 4.4,
        reviews: 95,
        seller: "ঐতিহাসিক তথ্য",
        hotDeal: false,
        description: "বিশ্ব ইতিহাসের গুরুত্বপূর্ণ ঘটনাগুলির বিস্তারিত বর্ণনা।"
    },
    {
        id: 12,
        title: "স্ব-উন্নয়ন বই",
        category: "বই",
        originalPrice: 1200,
        currentPrice: 499,
        emoji: "🌟",
        ...
        seller: "মোটিভেশন হাব",
        hotDeal: true,
        description: "আপনার জীবন পরিবর্তনের জন্য অনুপ্রেরণামূলক বই।"
    },
    ...
    // খেলনা
    {
        ...
        seller: "খেলনা স্বর্গ",
        hotDeal: false,
        description: "শিশুদের সৃজনশীলতা বিকাশের জন্য আদর্শ।"
    },
    {
        id: 14,
        title: "রোবট খেলনা",
        ...
        rating: 4.7,
        reviews: 180,
        seller: "স্মার্ট খেলনা",
        hotDeal: true,
        description: "ইন্টারঅ্যাক্টিভ এবং শিক্ষামূলক রোবট খেলনা।"
    },
    {
        id: 15,
        title: "পাজল গেম",
        ...
        rating: 4.3,
        reviews: 110,
        seller: "মস্তিষ্ক খেলা",
        hotDeal: false,
        description: "মানসিক দক্ষতা বৃদ্ধির জন্য মজাদার পাজল।"
    },
    {
        id: 16,
        title: "বোর্ড গেম",
        ...
        seller: "পরিবার খেলা",
        hotDeal: true,
        description: "পরিবারের সাথে মজার সময় কাটানোর জন্য।"
    },

    // হোম
    {
        id: 17,
        title: "LED লাইট বাল্ব",
        category: "হোম",
        originalPrice: 500,
        currentPrice: 199,
        emoji: "💡",
        ...
        seller: "হোম লাইট",
        hotDeal: true,
        description: "শক্তি সাশ্রয়ী এবং দীর্ঘস্থায়ী LED বাল্ব।"
    },
    {
        id: 18,
        title: "কিচেন ন্যাপকিন",
        category: "হোম",
        originalPrice: 400,
        currentPrice: 99,
        emoji: "🧻",
        ...
        seller: "হোম সাপ্লাই",
        hotDeal: false,
        description: "উচ্চমানের এবং টেকসই কিচেন ন্যাপকিন।"
    },
    {
        id: 19,
        title: "বিছানার চাদর",
        ...
        seller: "কম্ফোর্ট হোম",
        hotDeal: true,
        description: "নরম এবং আরামদায়ক বিছানার চাদর।"
    },
    {
        id: 20,
        title: "ডিনার সেট",
        ...
        rating: 4.6,
        reviews: 120,
        seller: "রান্নাঘর স্টোর",
        hotDeal: false,
        description: "সুন্দর এবং টেকসই ডিনার সেট।"
    },
    ...
    // বিউটি
    {
        ...
        seller: "বিউটি প্লাস",
        hotDeal: true,
        description: "ত্বকের জন্য নরম এবং কার্যকর ফেস ওয়াশ।"
    },
    {
        id: 22,
        title: "হেয়ার শ্যাম্পু",
        category: "বিউটি",
        originalPrice: 800,
        currentPrice: 399,
        emoji: "🧴",
        rating: 4.4,
        reviews: 220,
        seller: "হেয়ার কেয়ার",
        hotDeal: false,
        description: "চুলের স্বাস্থ্য বৃদ্ধির জন্য প্রাকৃতিক শ্যাম্পু।"
    },
    {
        id: 23,
        title: "লিপস্টিক কালেকশন",
        category: "বিউটি",
        originalPrice: 1200,
        currentPrice: 499,
        emoji: "💄",
        ...
        seller: "লিপস বিউটি",
        hotDeal: true,
        description: "রঙিন এবং দীর্ঘস্থায়ী লিপস্টিক।"
    },
    {
        id: 24,
        title: "মেইকআপ ব্রাশ সেট",
        category: "বিউটি",
        originalPrice: 1500,
        currentPrice: 599,
        emoji: "🖌️",
        rating: 4.3,
        reviews: 140,
        seller: "মেইকআপ স্টুডিও",
        hotDeal: false,
        description: "পেশাদার মানের মেইকআপ ব্রাশ সেট।"
    }
];
...
function filterProducts() {
    ...
    const rating3 = document.querySelectorAll('.filter-group input[type="checkbox"]')[1].checked;
    const rating2 = document.querySelectorAll('.filter-group input[type="checkbox"]')[2].checked;
    const hotDeal = document.querySelectorAll('.filter-group input[type="checkbox"]')[3].checked;
    const flashSale = document.querySelectorAll('.filter-group input[type="checkbox"]')[4].checked;
    ...
    let filtered = products.filter(p => {
        ...
        if (rating3 && p.rating < 3) pass = false;
        if (rating2 && p.rating < 2) pass = false;
        if (hotDeal && !p.hotDeal) pass = false;
        if (flashSale && p.discount < 30) pass = false;
...
function checkout() {
    ...
    alert(`✅ অর্ডার সফল!\n\nমোট: ৳ ${total.toLocaleString()}\n\n২-৩ দিনে আপনার দোরগোড়ায় পৌঁছে যাবে।`);
    cart = [];
    updateCart();
    toggleCart();
}
...
function showModal(product) {
    ...
    document.getElementById('modalImage').style.textAlign = 'center';
...
// AI চ্যাটবট
const aiResponses = {
    'আলো': 'আমরা আপনার জন্য LED বাল্ব, ডেস্ক ল্যাম্প এবং অন্যান্য আলোর ব্যবস্থা খুঁজে পেয়েছি। আপনি কি আগ্রহী?',
    'পোশাক': 'আমাদের কাছে টি-শার্ট, জিনস, জ্যাকেট এবং অন্যান্য ফ্যাশন আইটেম রয়েছে। কি ধরনের পোশাক খুঁজছেন?',
    'বই': 'আমাদের বিশাল বই সংগ্রহ রয়েছে - প্রোগ্রামিং, ইতিহাস, সাহিত্য এবং আরও অনেক কিছু।',
    'খেলনা': 'শিশুদের জন্য আমাদের কাছে শিক্ষামূলক খেলনা, রোবট, পাজল এবং বোর্ড গেম রয়েছে।',
    'দাম': 'আমরা সব ধরনের বাজেটের জন্য পণ্য অফার করি। সবচেয়ে সাশ্রয়ী থেকে প্রিমিয়াম পর্যন্ত।',
    'ছাড়': 'আমাদের আজকের হট ডিলে ৭০% পর্যন্ত ছাড় পাবেন! 🔥',
    'ডেলিভারি': 'আমরা ২-৩ দিনে বিনামূল্যে ডেলিভারি প্রদান করি।',
    'পেমেন্ট': 'আমরা সব ধরনের পেমেন্ট পদ্ধতি গ্রহণ করি - কার্ড, মোবাইল ব্যাংক, ক্যাশ অন ডেলিভারি।'
};
...
function sendChatMessage() {
    ...
    // AI রেসপন্স
    setTimeout(() => {
        let response = 'আমি বুঝতে পারলাম না। আপনি কি সাহায্য করতে পারবেন? 🤔';
...
// মডেল বন্ধ করা যখন বাহিরে ক্লিক করা হয়
